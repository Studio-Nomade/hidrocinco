...
$services = [
    [
        'slug' => 'pozos-profundos', 'title' => 'Pozos profundos', 'icon' => 'img/icons/pozos.png',
        'card_summary' => 'Ejecución, implementación y evaluación de pozos profundos.', 'sort_order' => 1, 'is_published' => true,
        'content' => [['type' => 'intro', 'title' => 'Sobre el servicio', 'paragraphs' => [
    ...
    [
        'slug' => 'plantas-de-tratamientos-de-aguas-servidas-ptas', 'title' => 'Plantas de tratamiento (PTAS)', 'icon' => 'img/icons/ptas.png',
        'card_summary' => 'Operación, mantenimiento e ingeniería para plantas de tratamiento.', 'sort_order' => 3, 'is_published' => true,
        'content' => [
            ['type' => 'intro', 'title' => 'Plan de mantenimiento', 'paragraphs' => [
    ...
    [
        'slug' => 'sala-de-calderas', 'title' => 'Sala de Calderas', 'icon' => 'img/icons/caldera.png',
        'card_summary' => 'Mantenimiento preventivo de calderas y atención de emergencias.', 'sort_order' => 4, 'is_published' => true,
        'content' => [['type' => 'intro', 'title' => 'Mantención', 'highlight_first' => true, 'paragraphs' => [
    ...
    [
        'slug' => 'taller-y-servicio-tecnico', 'title' => 'Taller y Servicio Técnico', 'icon' => 'img/icons/taller.png',
    ...
    [
        'slug' => 'limpia-fosas', 'title' => 'Limpia Fosas', 'icon' => 'img/icons/limpia-fosas.png',
    ...
    [
        'slug' => 'sala-de-bombas', 'title' => 'Sala de bombas', 'icon' => 'img/icons/bombas.png',
        'card_summary' => 'Mantenimiento preventivo, correctivo y monitoreo de sistemas de bombeo.', 'sort_order' => 7, 'is_published' => true,
        'content' => [
            ['type' => 'intro', 'title' => 'Mantención', 'highlight_first' => true, 'paragraphs' => [
...
$postData = [
    ...
    'featured_image' => 'img/blog/sistemas-hidraulicos.svg',
    'body_html' => <<<'HTML'
